...
- If invitation creation fails when inserting notification type `invite`, fix the live PostgreSQL notification check constraint.
...
- Add tests for invitations and role-update permissions.
