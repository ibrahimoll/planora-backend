...
from app.services.report_request_token_service import create_report_request_token
...
def build_send_report_url(
    *,
    ...
    request_token = create_report_request_token(
        project_id=project_id,
        requester_email=requester_email,
        requester_name=requester_name,
    )
    report_query = urlencode({"requestToken": request_token})
...
Open this secure link to sign in and auto-fill the admin Send Report page:
{send_url}

You only need to add your admin note and click Mark Ready & Notify User.
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;background:#ffffff;border:1px solid #e8def8;border-radius:22px;overflow:hidden;">
            <tr>
              <td style="padding:28px 30px;">
                ...
                <p style="margin:0 0 20px 0;color:#4b5563;font-size:15px;line-height:1.6;">Hello {safe_admin_name}, sign in and Planora will auto-fill the Send Report page from a signed request token.</p>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f8f5ff;border:1px solid #eadfff;border-radius:16px;">
                  <tr><td style="padding:18px 20px;color:#111827;font-size:15px;line-height:1.8;">
                    ...
                    <strong>Internal ref:</strong> PR-{safe_project_id}<br>
                ...
                <p style="margin:0;color:#6b7280;font-size:13px;line-height:1.6;">The link uses a signed token instead of exposing project ID and email in the URL. After signing in, add your admin note and notify the user.</p>
              </td>
            </tr>
          </table>
        </td>
