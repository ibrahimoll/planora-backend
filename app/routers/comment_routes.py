...
def get_comment_or_404(
    ...
    comment = get_comment_for_task_by_id(
        db=db,
        task=task,
...
def create_personal_task_comment(
    project_id: int,
    task_id: int,
...
def list_personal_task_comments(
    project_id: int,
    task_id: int,
    db: DBSession,
    current_user: CurrentUser,
...
def update_personal_task_comment(
    project_id: int,
    task_id: int,
    comment_id: int,
...
def delete_personal_task_comment(
    project_id: int,
    task_id: int,
    comment_id: int,
    db: DBSession,
...
@router.post(
    "/teams/{team_id}/projects/{project_id}/tasks/{task_id}/comments",
    response_model=CommentResponse,
    status_code=http_status.HTTP_201_CREATED,
)
def create_team_task_comment(
    team_id: int,
    project_id: int,
    task_id: int,
    comment_data: CommentCreate,
    ...
    task, _membership = require_team_task_access(
        db=db,
        team_id=team_id,
        project_id=project_id,
        task_id=task_id,
...
@router.get(
    "/teams/{team_id}/projects/{project_id}/tasks/{task_id}/comments/{comment_id}",
    response_model=CommentResponse,
)
def get_team_task_comment(
    team_id: int,
    project_id: int,
    task_id: int,
    comment_id: int,
...
def update_team_task_comment(
    ...
    task, membership = require_team_task_access(
        db=db,
        team_id=team_id,
        project_id=project_id,
        task_id=task_id,
    ...
    if not can_modify_team_comment(
        comment=comment,
